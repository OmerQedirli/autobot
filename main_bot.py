...
def generate_script():
    ...
    Choose two completely different vegetables each time (e.g., Tomato and Pepper, or Broccoli and Garlic, etc.).
    Create a short, funny 3-4 sentence dialogue between them about daily life in the fridge or absurd philosophy.
    
    Return the response ONLY as a valid JSON array without any markdown formatting or extra text, following this exact structure:
    [
...
def upload_to_youtube(video_path):
    ...
    body = {
        "snippet": {
            ...
            "description": "Automated absurd vegetable dialogues generated by AI!",
